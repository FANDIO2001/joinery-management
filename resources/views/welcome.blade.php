...
<head>
    ...
    <style>
        ...
        .hero-section {
            ...
            display: flex;
            Derniers Projets align-items: center;
    ...
    <nav class="navbar-custom fixed top-0 left-0 right-0 z-50" id="navbar">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-200">
            <div class="px-2 pt-2 pb-3 space-y-1">
                <a href="#"
                    class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Accueil</a>
                <a href="{{ route('shop.index') }}"
                    class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Boutique</a>
                <a href="#"
                    class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Services</a>
                <a href="#"
                    class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Réalisations</a>
                <a href="#"
                    class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Contact</a>
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Tableau
                        de bord</a>
                @else
                    <a href="{{ route('login') }}"
                        class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Connexion</a>
                    <a href="{{ route('register') }}"
                        class="block px-3 py-2 text-base font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50">S'inscrire</a>
                @endauth
            </div>
        </div>
    </nav>
    ...
    <section class="hero-section">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">
                ...
                <span class="subtitle-tertiary">nous permettent de réaliser des projets exceptionnels qui dépassent vos
                    attentes.</span>
            </p>
    ...
    <section class="services-section py-20">
        <div class="services-container">
            ...
            <div class="cards-grid">
                ...
                <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                    <div class="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mb-6 mx-auto">
                        <svg class="w-8 h-8 text-amber-600" fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M10 2a1 1 0 011 1v1a1 1 0 01-1 1H4a1 1 0 01-1-1V3a1 1 0 011-1h1a1 1 0 011 1v1a1 1 0 01-1 1H4a1 1 0 01-1-1V3a1 1 0 011-1h1zm4 0a1 1 0 011 1v1a1 1 0 01-1 1H4a1 1 0 01-1-1V3a1 1 0 011-1h1a1 1 0 011 1v1a1 1 0 01-1 1H4a1 1 0 01-1-1V3a1 1 0 011-1h1z" />
                        </svg>
                    </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                    <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-6 mx-auto">
                        <svg class="w-8 h-8 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M10.394 2.08a1 1 0 00-.788 0l-7 14a1 1 0 001.169.922l5.016-7.016a1 1 0 001.169-.922l-7-14a1 1 0 00-.788 0zm-1.169 14.2a1 1 0 01-.969.249L5.35 10.38a1 1 0 01-.969-.249L3.169 14.2a1 1 0 01-.969-.249l5.016-7.016a1 1 0 001.169-.922l5.016 7.016a1 1 0 001.169.922z" />
                        </svg>
                    </div>
                ...
                <!-- Service 3 -->
                <div
                    class="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                    <div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-6 mx-auto">
                        <svg class="w-8 h-8 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M9 2a1 1 0 000 2h2a1 1 0 000-2H9a1 1 0 000 2h2a1 1 0 000 2H9a1 1 0 000 2H9a1 1 0 000-2zm0 6a1 1 0 000 2h2a1 1 0 000-2H9a1 1 0 000 2h2a1 1 0 000 2H9a1 1 0 000 2H9a1 1 0 000-2zm0 6a1 1 0 000 2h2a1 1 0 000-2H9a1 1 0 000 2h2a1 1 0 000 2H9a1 1 0 000-2z" />
                        </svg>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 p-8 rounded-xl">
                    ...
                    <p class="text-gray-700 italic">
                        "Un travail d'une qualité exceptionnelle ! La table sur mesure que j'ai commandée dépasse toutes
                        mes attentes. Je recommande vivement DOLLARS MENUISERIE."
                    </p>
                </div>
                ...
                <div class="bg-gray-50 p-8 rounded-xl">
                    ...
                    <p class="text-gray-700 italic">
                        "Le service client est impeccable et la qualité des meubles est remarquable. J'ai fait rénover
                        toute ma maison avec eux et je suis très satisfait."
                    </p>
                </div>
                ...
                <div class="bg-gray-50 p-8 rounded-xl">
                    ...
                    <p class="text-gray-300 italic">
                        "Des artisans de grand talent ! Leurs pompes funèbres sont réalisées avec beaucoup de dignité et
                        respect. Un service très apprécié dans nos moments difficiles."
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="footer-container">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center mb-4">
                        <img src="{{ asset('images/hero/LOGO.jpg') }}" alt="DOLLARS MENUISERIE"
                            class="w-10 h-10 rounded-full mr-3">
                        <span class="text-xl font-bold">DOLLARS MENUISERIE</span>
                    </div>
                    <p class="text-gray-300 mb-4">
                        Votre partenaire de confiance pour tous vos projets de menuiserie, rénovation et services
                        funéraires depuis plus de 20 ans.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Menuiserie Sur
                                Mesure</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Rénovation</a>
                        </li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Conseil
                                Expert</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Pompes
                                Funèbres</a></li>
                    </ul>
                </div>
