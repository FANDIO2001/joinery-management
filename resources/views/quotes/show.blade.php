        ...
        <div style="padding:24px; max-width:1200px; margin:0 auto;">
            ...
            <div
                ...
                <div style="display:flex; gap:12px;">
                    ...
                    <button onclick="window.location.href='/quotes/1/edit'"
                        style="display:flex; align-items:center; gap:8px;
            ...
            <div style="display:grid; grid-template-columns:1fr 380px; gap:32px;">
                            ...
                            <div style="flex:1;">
                                ...
                                <div style="display:flex; gap:20px; flex-wrap:wrap;">
                                    ...
                                    <div style="display:flex; align-items:center; gap:8px;">
                                        ...
                                        <div>
                                            <div style="font-size:12px; color:#6b7280;">Validité</div>
                                            <div style="font-size:14px; font-weight:600; color:#1f2937;">05/05/2024</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div
                        ...
                        <div style="padding:0 24px 24px;">
                            <p style="color:#4b5563; line-height:1.6; margin:0;">
                                Table en chêne massif avec finitions personnalisées.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div
                        ...
                        <div style="padding:0 24px 24px;">
                            <span
                                style="display:inline-flex; align-items:center; gap:6px; padding:6px 16px; background:#dbeafe; color:#2563eb; font-size:14px; font-weight:600; border-radius:20px;">
                                <div style="width:8px; height:8px; background:#3b82f6; border-radius:50%;"></div>
                                Envoyé
                            </span>
                        </div>
                    ...
                    <div
                        ...
                        <div style="padding:0 24px 24px; text-align:center;">
                            <div style="font-size:32px; font-weight:700; color:#1f2937; margin-bottom:4px;">450 000 FCFA
                            </div>
                        </div>
                    </div>
                        ...
                        <div style="padding:0 24px 24px;">
                            <div style="position:relative; padding-left:20px;">
                                ...
                                <div style="position:relative;">
                                    ...
                                    <div>
                                        <div style="font-size:13px; font-weight:600; color:#1f2937; margin-bottom:2px;">
                                            Envoyé au client</div>
                                        <div style="font-size:12px; color:#6b7280;">06/04/2024</div>
                                    </div>
                                </div>
                            </div>
                        </div>
