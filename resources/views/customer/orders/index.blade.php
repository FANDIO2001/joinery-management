        ...
        <div style="padding:24px; max-width:1400px; margin:0 auto;">
            ...
            <div
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:20px;">
                    <div>
                        ...
                        <input type="text" id="search" name="search" placeholder="Référence, client..."
            ...
            <div
                ...
                <div style="background:#f9fafb; padding:16px 24px; border-bottom:1px solid #e5e7eb;">
                    <div
                        style="display:grid; grid-template-columns:1fr 1fr 1fr 1fr 1fr 1.5fr; gap:16px; align-items:center;">
                        <div
                ...
                <div style="padding:0;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr 1fr 1fr 1fr 1.5fr; gap:16px; align-items:center; padding:20px 24px; border-bottom:1px solid #f3f4f6; transition:background-color 0.2s;"
                        ...
                        <div style="font-size:14px; color:#374151;">{{ $order->client->name ?? 'Client' }}</div>
                        ...
                        <div>
                            ...
                            <span
                                ...
                                <div style="width:6px; height:6px; background:{{ $status['dot'] }}; border-radius:50%;"></div>
                                {{ $status['label'] }}
                            </span>
                        </div>
                    ...
                    <div style="padding:40px; text-align:center; color:#6b7280;">
                        <p style="font-size:16px;">Aucune commande trouvée</p>
                    </div>
                    @endforelse
                </div>
