    ...
    <div id="profile">
        <div style="padding:24px; max-width:1000px; margin:0 auto;">
            ...
            <div style="display:grid; grid-template-columns:1fr 2fr; gap:24px;">
                ...
                <!-- Avatar Section -->
                <div
                    style="background:white; border-radius:12px; padding:32px; box-shadow:0 4px 6px rgba(0,0,0,0.05); border:1px solid #e5e7eb; text-align:center;">
                    <img src="https://ui-avatars.com/api/?name=Jean Dupont&background=1e3a8a&color=fff" alt="Avatar"
                        style="width:150px; height:150px; border-radius:50%; border:4px solid #e5e7eb; margin-bottom:16px;">
                    ...
                    <div
                        style="display:inline-flex; align-items:center; gap:8px; padding:6px 12px; background:#dcfce7; color:#16a34a; font-size:12px; font-weight:600; border-radius:12px;">
                ...
                <!-- Details Section -->
                <div
                    style="background:white; border-radius:12px; padding:32px; box-shadow:0 4px 6px rgba(0,0,0,0.05); border:1px solid #e5e7eb;">
                    <h3
                        style="font-size:18px; font-weight:600; color:#1f2937; margin:0 0 24px; padding-bottom:16px; border-bottom:1px solid #e5e7eb;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:24px;">
                        <div>
                            <h4
                                style="font-size:14px; font-weight:600; color:#6b7280; margin:0 0 8px; text-transform:uppercase; letter-spacing:0.05em;">
                                Nom complet
                            </h4>
            ...
            <!-- Account Statistics -->
            <div
                style="margin-top:24px; background:white; border-radius:12px; padding:32px; box-shadow:0 4px 6px rgba(0,0,0,0.05); border:1px solid #e5e7eb;">
                <h3
                    style="font-size:18px; font-weight:600; color:#1f2937; margin:0 0 24px; padding-bottom:16px; border-bottom:1px solid #e5e7eb;">
