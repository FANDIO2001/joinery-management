    ...
    <div style="padding:24px; max-width:1200px; margin:0 auto;">
        ...
        <div style="display:flex; justify-content:space-between; 
            ...
            <div style="display:flex; gap:12px;">
                ...
                <button onclick="window.location.href='/customers/1/edit'"
                    style="display:flex; align-items:center; gap:8px;
        ...
        <div style="display:grid; grid-template-columns:1fr 380px; gap:32px;">
            ...
            <div>
                            ...
                            <div style="display:flex; gap:20px; flex-wrap:wrap;">
                                <div style="display:flex; align-items:center; gap:8px;">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size:14px; font-weight:600; color:#1f2937;">jean.dupont@email.com</div>
                                    </div>
                                </div>
                                <div style="display:flex; align-items:center; gap:8px;">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size:14px; font-weight:600; color:#1f2937;">+237 699 123 456</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div style="background:white; border-radius:16px;
                    ...
                    <div style="padding:0 24px 24px;">
                        <p style="color:#4b5563; line-height:1.6; margin:0;">
                            Client fidèle, préfère les paiements Mobile Money. A effectué 5 commandes cette année.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div style="background:white; border-radius:16px;
                    ...
                    <div style="padding:0 24px 24px;">
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
                            ...
                            <div style="font-size:18px; font-weight:700; color:#1f2937;">5</div>
                        </div>
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
                            <div style="font-size:13px; color:#6b7280;">Total dépensé</div>
                            <div style="font-size:18px; font-weight:700; color:#10b981;">2 500 000 FCFA</div>
                        </div>
                    ...
                    <div style="padding:0 24px 24px;">
                        <div style="position:relative; padding-left:20px;">
                            ...
                            <div style="position:relative;">
                                ...
                                <div>
                                    <div style="font-size:13px; font-weight:600; color:#1f2937; margin-bottom:2px;">Dernière commande</div>
