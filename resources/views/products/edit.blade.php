    ...
    <div style="padding:24px; max-width:800px; margin:0 auto;">
        ...
        <div style="background:white; border-radius:12px;
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="text" name="product_name" value="Table en chêne"
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="text" name="product_reference" value="TAB-001"
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr;
                ...
                <div>
                    ...
                    <select name="product_category"
                        ...
                        <option value="furniture" selected>Meubles</option>
                ...
                <div>
                    ...
                    <input type="number" name="product_price" value="45000"
                        placeholder="0"
                        style="width:100%; padding:12px 16px;
                               border:2px solid #e5e7eb; border-radius:8px;
                               font-size:15px; box-sizing:border-box;
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr 1fr;
                ...
                <div>
                    ...
                    <input type="number" name="current_stock" value="12"
                        placeholder="0"
                        style="width:100%; padding:12px 16px;
                               border:2px solid #e5e7eb; border-radius:8px;
                ...
                <div>
                    ...
                    <input type="number" name="max_stock" value="50"
                        placeholder="100"
                        style="width:100%; padding:12px 16px;
                               border:2px solid #e5e7eb; border-radius:8px;
                               font-size:15px; box-sizing:border-box; outline:none;"
            ...
            <div style="margin-bottom:20px;">
                ...
                <textarea name="product_description" rows="4"
                    ...
                    onfocus="this.style.borderColor='#10b981'"
                    onblur="this.style.borderColor='#e5e7eb'">Table de salle à manger en chêne massif, fabrication artisanale française. Dimensions: 180x90x75 cm. Finition vernis naturel. Convient pour 6 à 8 personnes. Garantie 5 ans.</textarea>
            </div>
