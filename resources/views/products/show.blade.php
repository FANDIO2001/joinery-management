                    ...
                    <div
                        ...
                        <div style="display:flex; gap:24px; align-items:flex-start;">
                            <div
                                ...
                                <svg style="width:48px; height:48px; color:#9ca3af;" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                ...
                                <div style="display:flex; gap:20px; flex-wrap:wrap;">
                                    <div style="display:flex; align-items:center; gap:8px;">
                                        ...
                                        <div>
                                            ...
                                            <div style="font-size:14px; font-weight:600; color:#1f2937;">{{ $product->sku }}
                                            </div>
                                        </div>
                                    </div>
                                    <div style="display:flex; align-items:center; gap:8px;">
                                    ...
                                    <div style="display:flex; align-items:center; gap:8px;">
                                        ...
                                        <div>
                                            ...
                                            @if ($product->status === 'active')
                                                <div
                                                    style="display:flex; align-items:center; gap:6px; padding:2px 8px; background:#dcfce7; color:#16a34a; font-size:12px; font-weight:600; border-radius:12px;">
                                                    <div
                                                        style="width:4px; height:4px; background:#22c55e; border-radius:50%;">
                                                    </div>
                                                    Actif
                                                </div>
                                            @else
                                                <div
                                                    style="display:flex; align-items:center; gap:6px; padding:2px 8px; background:#fef3c7; color:#d97706; font-size:12px; font-weight:600; border-radius:12px;">
                                                    <div
                                                        style="width:4px; height:4px; background:#f59e0b; border-radius:50%;">
                                                    </div>
                                                    Brouillon
                                                </div>
                                            @endif
                        ...
                        <div style="padding:0 24px 24px;">
                            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                                ...
                                <div style="background:#f9fafb; padding:16px; border-radius:8px; border:1px solid #e5e7eb;">
                                    ...
                                    <div style="font-size:14px; font-weight:600; color:#1f2937;">
                                        {{ $product->weight_kg ?? 'N/A' }} kg</div>
                                </div>
                                @if (isset($product->dimensions['material']))
                                    <div
                                        ...
                                        <div style="font-size:14px; font-weight:600; color:#1f2937;">
                                            {{ $product->dimensions['material'] }}</div>
                                    </div>
                                @endif
                                @if (isset($product->dimensions['finish']))
                                    <div
                                        style="background:#f9fafb; padding:16px; border-radius:8px; border:1px solid #e5e7eb;">
                                        <div style="font-size:12px; color:#6b7280; margin-bottom:4px;">Finition</div>
                                        <div style="font-size:14px; font-weight:600; color:#1f2937;">
                                            {{ $product->dimensions['finish'] }}</div>
                                    </div>
                                @endif
                                <div style="background:#f9fafb; padding:16px; border-radius:8px; border:1px solid #e5e7eb;">
                                    <div style="font-size:12px; color:#6b7280; margin-bottom:4px;">Personnalisable</div>
                                    <div style="font-size:14px; font-weight:600; color:#1f2937;">
                                        {{ $product->is_customizable ? 'Oui' : 'Non' }}</div>
                                </div>
                                <div style="background:#f9fafb; padding:16px; border-radius:8px; border:1px solid #e5e7eb;">
                                    <div style="font-size:12px; color:#6b7280; margin-bottom:4px;">Jours de fab.</div>
                                    <div style="font-size:14px; font-weight:600; color:#1f2937;">
                                        {{ $product->min_fabrication_days ?? 'N/A' }} jours</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div
                        ...
                        <div style="padding:0 24px 24px; text-align:center;">
                            ...
                            <div style="font-size:14px; color:#6b7280;">Prix TTC</div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div style="padding:16px 24px 8px;">
                            <h3
                                style="font-size:18px; font-weight:700; color:#1f2937; margin:0; display:flex; align-items:center; gap:8px;">
                                <span
                                    style="width:24px; height:24px; background:#8b5cf6; border-radius:6px; display:flex; align-items:center; justify-content:center;">
                        ...
                        <div style="padding:0 24px 24px;">
                            ...
                            <div
                                style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
                                <div style="font-size:13px; color:#6b7280;">Variantes</div>
                                <div style="font-size:14px; font-weight:600; color:#1f2937;">
                                    {{ $product->variants->count() ?? 0 }}</div>
                            </div>
                            <div style="display:flex; justify-content:space-between; align-items:center;">
                                <div style="font-size:13px; color:#6b7280;">Créé le</div>
                                <div style="font-size:14px; font-weight:600; color:#1f2937;">
                                    {{ $product->created_at->format('d/m/Y') }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div style="padding:0 24px 24px; display:flex; flex-direction:column; gap:12px;">
                            <a href="{{ route('products.edit', $product->id) }}"
                                style="display:block; text-align:center; padding:12px 16px; background:linear-gradient(135deg, #10b981, #059669); color:white; border:none; border-radius:8px; font-size:14px; font-weight:600; cursor:pointer; transition:all 0.2s; box-shadow:0 4px 12px rgba(16,185,129,0.3); text-decoration:none;"
                            ...
                            <form action="{{ route('products.destroy', $product->id) }}" method="POST"
                                ...
                                @method('DELETE')
                                <button type="submit"
                                    style="width:100%; padding:12px 16px; background:linear-gradient(135deg, #ef4444, #dc2626); color:white; border:none; border-radius:8px; font-size:14px; font-weight:600; cursor:pointer; transition:all 0.2s; box-shadow:0 4px 12px rgba(239,68,68,0.3);"
                            ...
                            <div style="position:relative; padding-left:20px;">
                                ...
                                <div style="position:relative;">
                                    ...
                                    <div>
                                        <div style="font-size:13px; font-weight:600; color:#1f2937; margin-bottom:2px;">
                                            Vues</div>
                                        <div style="font-size:12px; color:#6b7280;">{{ $product->views_count ?? 0 }}
                                            consultations</div>
                                    </div>
                                </div>
                            </div>
