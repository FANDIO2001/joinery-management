        ...
        <div style="padding:24px; max-width:1400px; margin:0 auto;">
            ...
            <div
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:20px;">
                    <div>
                        ...
                        <input type="text" id="search" name="search" placeholder="Nom, poste..."
                    ...
                    <div>
                        ...
                        <select id="department" name="department"
                            ...
                            <option value="sales">Personel</option>
            ...
            <div
                ...
                <div style="background:#f9fafb; padding:16px 24px; border-bottom:1px solid #e5e7eb;">
                    <div
                        style="display:grid; grid-template-columns:2fr 1fr 1fr 1fr 1fr 1.5fr; gap:16px; align-items:center;">
                        <div
                ...
                <div style="padding:0;">
                    <div style="display:grid; grid-template-columns:2fr 1fr 1fr 1fr 1fr 1.5fr; gap:16px; align-items:center; padding:20px 24px; border-bottom:1px solid #f3f4f6; transition:background-color 0.2s;"
                        ...
                        <div style="display:flex; align-items:center; gap:16px;">
                            ...
                            <div>
                                <div style="font-size:15px; font-weight:600; color:#1f2937; margin-bottom:2px;">Pierre
                                    Martin</div>
