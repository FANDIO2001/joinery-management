    ...
    <div style="padding:24px; max-width:800px; margin:0 auto;">
        ...
        <div style="background:white; border-radius:12px;
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="text" name="employee_name" value="Pierre Martin"
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr;
                ...
                <div>
                    ...
                    <input type="email" name="employee_email" value="pierre.martin@email.com"
                ...
                <div>
                    ...
                    <input type="tel" name="employee_phone" value="+237 698 234 567"
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr;
                ...
                <div>
                    ...
                    <input type="text" name="employee_position" value="Artisan Menuisier"
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="number" name="employee_salary" value="150000"
                    placeholder="150000"
                    style="width:100%; padding:12px 16px;
                           border:2px solid #e5e7eb; border-radius:8px;
                           font-size:15px; box-sizing:border-box;
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="text" name="employee_address" value="456 Avenue des Artisans"
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="date" name="employee_hire_date" value="2023-01-15"
                    style="width:100%; padding:12px 16px;
                           border:2px solid #e5e7eb; border-radius:8px;
                           font-size:15px; box-sizing:border-box;
                           outline:none; transition:border-color 0.2s;"
