        ...
        <div style="background:white; border-radius:16px;
            ...
            <div style="padding:0;">
                <div style="display:grid; grid-template-columns:1fr 1fr 1fr 1fr 1fr 1.5fr; gap:16px; align-items:center; padding:20px 24px; border-bottom:1px solid #f3f4f6; transition:background-color 0.2s;"
                    ...
                    <div style="font-size:14px; font-weight:600; color:#1f2937;">CMD-2024-001</div>
                    ...
                    <div>
                        <span style="display:inline-flex; align-items:center; gap:6px; padding:4px 12px; background:#dbeafe; color:#2563eb; font-size:12px; font-weight:600; border-radius:20px;">
                            <div style="width:6px; height:6px; background:#3b82f6; border-radius:50%;"></div>
                            En cours
                        </span>
                    </div>
                    <div style="display:flex; gap:8px;">
                        <button onclick="window.location.href='/orders/1'"
