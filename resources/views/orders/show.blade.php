    ...
    <div style="padding:24px; max-width:1200px; margin:0 auto;">
        ...
        <div style="display:flex; justify-content:space-between; 
            ...
            <div style="display:flex; gap:12px;">
                ...
                <button onclick="window.location.href='/orders/1/edit'"
                    style="display:flex; align-items:center; gap:8px;
        ...
        <div style="display:grid; grid-template-columns:1fr 380px; gap:32px;">
                ...
                <div style="background:white; border-radius:16px;
                    ...
                    <div style="padding:0 24px 24px;">
                        <p style="color:#4b5563; line-height:1.6; margin:0;">
                            Client préfère livraison le samedi matin.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div style="background:white; border-radius:16px;
                    ...
                    <div style="padding:0 24px 24px;">
                        <span style="display:inline-flex; align-items:center; gap:6px; padding:6px 16px; background:#dbeafe; color:#2563eb; font-size:14px; font-weight:600; border-radius:20px;">
                            <div style="width:8px; height:8px; background:#3b82f6; border-radius:50%;"></div>
                            En cours
                        </span>
                    </div>
                    ...
                    <div style="padding:0 24px 24px;">
                        <div style="position:relative; padding-left:20px;">
                            ...
                            <div style="position:relative;">
                                ...
                                <div>
                                    <div style="font-size:13px; font-weight:600; color:#1f2937; margin-bottom:2px;">Statut changé</div>
                                    <div style="font-size:12px; color:#6b7280;">06/04/2024 - En cours</div>
                                </div>
                            </div>
                        </div>
                    </div>
