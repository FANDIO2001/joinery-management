...
<aside class="sidebar">
    ...
    <div class="sidebar-brand">
        <div class="brand-logo">
            <img src="{{ asset('images/hero/logo-dollars.jpg') }}" alt="DOLLARS MENUISERIE" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
    ...
    <nav class="sidebar-nav">
        ...
        <!-- Production -->
        <a href="{{ route('production.calendar') }}" class="sidebar-nav-item {{ request()->routeIs('production.*') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Mouvements Stock -->
        <a href="{{ route('stocks.movements') }}" class="sidebar-nav-item {{ request()->routeIs('stocks.movements') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Alertes Stock -->
        <a href="{{ route('stocks.alerts') }}" class="sidebar-nav-item {{ request()->routeIs('stocks.alerts') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Congés -->
        <a href="{{ route('employees.leaves.all') }}" class="sidebar-nav-item {{ request()->routeIs('employees.leaves.*') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Livraisons -->
        <a href="{{ route('deliveries.index') }}" class="sidebar-nav-item {{ request()->routeIs('deliveries.*') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- SAV -->
        <a href="{{ route('sav.index') }}" class="sidebar-nav-item {{ request()->routeIs('sav.*') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Notifications -->
        <a href="{{ route('notifications.index') }}" class="sidebar-nav-item {{ request()->routeIs('notifications.*') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
